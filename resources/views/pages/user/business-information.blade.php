...
<!--                                                @if(!empty($selected_id_value->id)){
                                    ...
                                    <form class="common-form" id="addEditBusinessInfo" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        @endif
                                        <div class="row data-section pos_rel">
                                            <div class="col-md-6 no-flex bus_cer_main">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#submitBtnBusiness', function (e) {
            ...
            if (edit_id == "") {
                $("#addEditBusinessInfo").attr('action', BASE_URL + "/" + 'business-information');
            } else {
                $("#addEditBusinessInfo").attr('action', BASE_URL + "/" + 'business-information' + "/" + user_id);
                $("#type").val('PUT');
            }
...
//        $(document).on('click', '.deleteBusiInfo', function (e) {
//            e.preventDefault();
//            var id = $(this).attr('id');
//            alert(id);
//            $.ajaxSetup({
