                ...
                <nav>
                    <div class="container pd0">
                        <div class="nav nav-tabs " id="nav-tab" role="tablist">
                            <a class="nav-item nav-link" href="{{URL('/individual-account/'.$user_id)}}">Account</a>
                            <a class="nav-item nav-link active" href="{{URL('/individual-security/'.$user_id)}}">Security</a>
                        </div>
                    </div>
                </nav>
                                    ...
                                    <div class="row-item">
                                        ...
                                        <h4>Change Password</h4>
                                         @if (session('status'))
                                            ...
                                            @endif
                                            <form class="common-form myform" id="passwordchange" method="POST" action="{{URL('/individual-security/'.$user_id)}}">                
                                            {{ csrf_field() }}
                                            <div class="row">
