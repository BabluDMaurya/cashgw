                ...
                <nav>
                    <div class="container pd0">
                        <div class="nav nav-tabs " id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" href="{{URL('/individual-account/'.$user_id)}}">Account</a>
                            <a class="nav-item nav-link" href="{{URL('/individual-security/'.$user_id)}}">Security</a>
                        </div>
                    </div>
                </nav>
                <div class="tab-content py-3 px-3 px-sm-0 container" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                                ...
                                <div class="block-item shadow-block">
                                    ...
                                    <div class="name-det"> 
                                        ...
                                        <div class="img-side">  
                                            ...
                                            <input type="file" accept="image/png, image/jpeg, image/jpg" class="custom-file-input upload_pro_image {{ $errors->has('myphoto') ? ' is-invalid' : '' }}" id="upload_image" img_id="myImg" img_height="224" img_width="325" imagefolder="images" required="" aria-required="true">  
                                        ...
                                        @endif
                                        <div>
                                            <p class="block-name">{{$individualkyc->fname}}</p> 
                            ...
                            <div class="col-md-6">
                                <div class="block-item shadow-block">  
                                    @if(empty($individualkyc->add_line_one) || empty($individual->billing_address_line_one))
                                    ...
                                    <div class="detail-det">                                                                                 
                                        <div class="d-flex">
                                            <div class="twodivide">
                                                ...
                                                <p class="pr15">{{ $individualkyc->add_line_one }},{{ $individualkyc->add_line_two }},{{ $individualkyc->town_or_city }},<br>{{ $individualkyc->country }},{{ $individualkyc->zip }}<br>
                                                    <a href="#!" id="primary" data-toggle="modal" data-target="#edit-address-primary" class="editUserAddress">Edit</a></p>
                                            </div>
                                            @if(!empty($individual->billing_address_line_one))
                                            <div class="secondary_address twodivide">
                                                <p class="larger-text">Secondary Address</p>
                                                <p class="pr15">{{ $individual->billing_address_line_one }},{{ $individual->billing_address_line_two }},{{ $individual->billing_address_townOrcity }},<br>{{ $individual->billing_address_country }},{{ $individual->billing_address_zipcode }}<br>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="block-item shadow-block">
                                    ...
                                    <form action="{{URL('/individual-account/'.$user_id)}}" class="common-form myform" id="PersonalDetails" method="POST">
                                        {{ csrf_field() }}
                                        <div class="form-group row">
                                            <input type="hidden" name="_method" value="PUT" />
                                            <label for="FirstName" class="col-lg-4 col-form-label ">First Name</label>
                                            <div class="col-lg-8">
                                                <input id="test1" type="text" class="form-control {{ $errors->has('FirstName') ? ' is-invalid' : '' }}" name="FirstName" value="{{ $individualkyc->fname}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control {{ $errors->has('MiddleName') ? ' is-invalid' : '' }}" name="MiddleName" value="{{ $individualkyc->mname}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text"  id="test2" class="form-control {{ $errors->has('LastName') ? ' is-invalid' : '' }}" name="LastName" value="{{ $individualkyc->lname}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="form-control {{ $errors->has('LangId') ? ' is-invalid' : '' }}" name="LangId">
                                                    ...
                                                    <option value="1" {{$individual->lang == 1 ? 'selected' : ''}}>English</option>
                                                    <option value="2" {{$individual->lang == 2 ? 'selected' : ''}}>Hindi</option>
                                                    <option value="3" {{$individual->lang == 3 ? 'selected' : ''}}>German</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <select class="form-control {{ $errors->has('Country') ? ' is-invalid' : '' }}" name="Country">
                                                    ...
                                                    <option value="India" {{ $individualkyc->country == 'India' ? 'selected' : ''}}>India</option>
                                                    <option value="UK" {{ $individualkyc->country == 'UK' ? 'selected' : '' }}>UK</option>
                                                    <option value="USA" {{ $individualkyc->country == 'USA' ? 'selected' : '' }}>USA</option>                                                                                
                                                </select>
                            ...
                            <div class="col-md-6 d-flex flex-column">
                                <div class="block-item shadow-block">
                                    @if(empty($individual->primary_email) || empty($individual->secondary_email))
                                    ...
                                    <div class="detail-det">
                                        <div class="d-flex">
                                            @if(!empty($individual->primary_email))
                                                <div class="twodivide">
                                                    <p class="larger-text">Primary Email</p> 
                                                    <p id="3" class="pr15">
                                                        {{$individual->primary_email}}<br>                                                        
                                                    </p>
                                                </div>       
                                            @endif     
                                            @if(!empty($individual->secondary_email))
                                                <div class="secondary_emailaddress twodivide">
                                                    <p class="larger-text">Secondary Email</p>
                                                    <p id="4" class="pr15">
                                                        {{$individual->secondary_email}}<br>
                                                        <a href="#!" class="editEmail anchortag" id="secondary" data-no="{{$individual->secondary_email}}" data-id="2" data-toggle="modal" data-target="#edit-email-address">Edit</a>
                                ...
                                <div class="block-item shadow-block"> 
                                    @if(empty($individual->primary_phone) || empty($individual->secondary_phone))
                                            ...
                                            <div class="detail-det">
                                                ...
                                                @if(!empty($individual->primary_phone))
                                                    <div class="twodivide">
                                                        ...
                                                        <p class="pr15">{{$individual->primary_phone}}<br>
                                                           <a href="#!" id="primary" class="editPhone anchortag" data-no="{{$individual->primary_phone}}" data-id="1" data-toggle="modal" data-target="#edit-phone">Edit</a>                                                           
                                                        </p>
                                                    </div>
                                                @endif   
                                                @if(!empty($individual->secondary_phone))
                                                    <div class="secondary_phone twodivide">
                                                        <p class="larger-text">Mobile,
        
                                                        </p>
                                                        <p class="pr15">{{$individual->secondary_phone}}<br>
                                                            <a href="#!" id="secondary" class="editPhone anchortag" data-no="{{$individual->secondary_phone}}" data-id="2" data-toggle="modal" data-target="#edit-phone">Edit</a>                                                           
                                                        </p>    
                                                    </div>
                                                @endif    
                                                </div>  
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{URL('/individual-account/')}}" class="common-form myform" id="AddAddress" method="post">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    @if(empty($individualkyc->add_line_one))
                    <div class="row">
                        <div class="col-md-12">
...
<div class="modal fade" tabindex="-1" data-keyboard="false" data-backdrop="static" id="edit-address-primary">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form id="edit-address-primary-form" action="{{URL('/individual-account/')}}" class="common-form primaryAdd" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}                    
                    <div class="row">
                        <div class="col-md-6 form-group required">
                            <input type="hidden" name="primaryaddressvalue" value="3">
                            <input type="hidden" name="role" value="1">
                            <input type="text" class="form-control {{ $errors->has('AddressLineOne') ? ' is-invalid' : '' }}" placeholder="Address Line 1" name="AddressLineOne" value="{{ $individualkyc->add_line_one }}">
                        ...
                        <div class="col-md-6 form-group">                                
                            <input type="text" class="form-control" placeholder="Address Line 2"  name="AddressLineTwo" value="{{ $individualkyc->add_line_two }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group required">                              
                            <input type="text" class="form-control {{ $errors->has('TownOrCity') ? ' is-invalid' : '' }}" placeholder="Town/ City"  name="TownOrCity" value="{{ $individualkyc->town_or_city }}">
                        ...
                        <div class="col-md-6 form-group">                                 
                            <input type="text" class="form-control {{ $errors->has('Zipcode') ? ' is-invalid' : '' }}" placeholder="Zipcode" name="Zipcode" value="{{ $individualkyc->zip }}">
                    ...
                    <div class="row">  
                        <div class="col-md-6 form-group">                                 
                            <input type="text" class="form-control {{ $errors->has('State') ? ' is-invalid' : '' }}" placeholder="State" name="State" value="{{ $individualkyc->state }}">
                            @if ($errors->has('State'))
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('State') }}</strong>
                                </span>
                        ...
                        <div class="col-md-6 form-group">                              
                            <select class="form-control {{ $errors->has('Country') ? ' is-invalid' : '' }}" name="Country">
                                <option value="" {{ $individualkyc->country == '' ? 'selected' : ''}}>Please Select Country</option>
                                <option value="India" {{ $individualkyc->country == 'India' ? 'selected' : ''}}>India</option>
                                <option value="UK" {{ $individualkyc->country == 'UK' ? 'selected' : '' }}>UK</option>
                                <option value="USA" {{ $individualkyc->country == 'USA' ? 'selected' : '' }}>USA</option>                          
                            </select>
                        ...
                        <div class="fileinput fileinput-new" id="input_file_pos_rel" data-provides="fileinput">
                                <div class="input-group input-large">
                                    ...
                                    <a href="javascript:;" class="input-group-addon btn red fileinput-exists" data-dismiss="fileinput">
                                        Remove </a>
                                    <div id="image-holder">
                                        <input type="hidden" name="approvalproofaddressold" value="{{$individualkyc->address_proof}}"/>
                                           <img src="{{url('/public/images/')}}/{{decrypt($user_id)}}/{{$individualkyc->address_proof}}" />
                                </div>                            
                            </div>
                            </div>
...
<!--                        <label>Proof of address <span class="asterik">*</span></label>
                        @if ($errors->has('approvalproofaddress'))
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('approvalproofaddress') }}</strong>
                        </span>                            
                        @endif 
                        <input type="file" name="approvalproofaddress" class="{{ $errors->has('approvalproofaddress') ? ' is-invalid' : '' }}">                         -->
                    </div>                     
                    <div class="col-lg-10 margin-auto">
...
<div class="modal fade " tabindex="-1" data-keyboard="false" data-backdrop="static" id="edit-address-billing">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form  action="{{URL('/individual-account/'.$user_id)}}" class="common-form myform" id="EditBillingAddress" method="post">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-6 form-group required">
                            <input type="hidden" name="_method" value="PUT" />
                            <input type="hidden" name="addressvalue" value="2" />                            
                            <input type="text" class="form-control {{ $errors->has('addlone') ? ' is-invalid' : '' }}" placeholder="Address Line 1" name="addlone" value="{{ $individual->billing_address_line_one }}">
                            @if ($errors->has('addlone'))
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('addlone') }}</strong>
                                </span>
                        ...
                        <div class="col-md-6 form-group">                                
                            <input type="text" class="form-control" placeholder="Address Line 2"  name="addltwo" value="{{ $individual->billing_address_line_two }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group required">                              
                            <input type="text" class="form-control {{ $errors->has('towncity') ? ' is-invalid' : '' }}" placeholder="Town/ City"  name="towncity" value="{{ $individual->billing_address_townOrcity }}">
                            @if ($errors->has('towncity'))
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('towncity') }}</strong>
                                </span>
                        ...
                        <div class="col-md-6 form-group">                                 
                            <input type="text" class="form-control {{ $errors->has('zip') ? ' is-invalid' : '' }}" placeholder="Zipcode" name="zip" value="{{ $individual->billing_address_zipcode }}">
                            @if ($errors->has('zip'))
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('zip') }}</strong>
                                </span>
                    ...
                    <div class="row">  
                        <div class="col-md-6 form-group">                                 
                            <input type="text" class="form-control {{ $errors->has('state') ? ' is-invalid' : '' }}" placeholder="State" name="state" value="{{ $individual->billing_address_state }}">
                            @if ($errors->has('state'))
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('state') }}</strong>
                                </span>
                        ...
                        <div class="col-md-6 form-group">                              
                            <select class="form-control {{ $errors->has('country') ? ' is-invalid' : '' }}" name="country">
                                <option value="" {{ $individual->billing_address_country == '' ? 'selected' : ''}}>Please Select Country</option>
                                <option value="India" {{ $individual->billing_address_country == 'India' ? 'selected' : ''}}>India</option>
                                <option value="UK" {{$individual->billing_address_country == 'UK' ? 'selected' : '' }}>UK</option>
                                <option value="USA" {{$individual->billing_address_country == 'USA' ? 'selected' : '' }}>USA</option>                            
                            </select>
                            @if ($errors->has('country'))
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('country') }}</strong>
...
<div class="modal fade "  tabindex="-1" data-keyboard="false" data-backdrop="static" id="add-email-address">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form action="{{URL('/individual-account')}}" class="common-form myform" method="POST" id="AddEmailAddress">                
                    {{ csrf_field() }}
                    <div class="row">
...
<div class="modal fade " tabindex="-1" data-keyboard="false" data-backdrop="static" id="edit-email-address">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form action="{{URL('/individual-account/'.$user_id)}}" class="common-form myform" method="POST" id="EditEmailAddress">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12 form-group required">
                            <input type="hidden" name="_method" value="PUT" />
...
<div class="modal fade " tabindex="-1" data-keyboard="false" data-backdrop="static" id="add-phone">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
...
<div class="modal fade " tabindex="-1" data-keyboard="false" data-backdrop="static" id="edit-phone">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form action="{{URL('/individual-account/'.$user_id)}}" class="common-form myform" method="POST" id="EditPhoneNumber">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12 form-group required">
                            <input type="hidden" name="_method" value="PUT" />
...
<div class="modal fade" tabindex="-1" data-keyboard="false" data-backdrop="static" id="close-your-account">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <form action="{{URL('/individual-account/'.$user_id)}}" method="post" class="form-horizontal">
                    {{ csrf_field() }}
...
<div id="uploadimageModal2" tabindex="-1" data-keyboard="false" data-backdrop="static" class="modal" role="dialog">
