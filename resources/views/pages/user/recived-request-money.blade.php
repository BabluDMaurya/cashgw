        ...
        <div class="row">
            ...
            <div class="tab-content py-3 px-3 px-sm-0 container" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="block-item shadow-block add_balance">
                                    <div class="filter-sec">
                                       <p class="price-b"> 
                                        ...
                                        <button type="button" class="btn btn-primary round-btn text-center mb-20" data-toggle="modal" data-target="#addbalance"> Add Balance</button>
                                    </div>
...
<div class="modal fade " id="accept">
    <div class="modal-dialog modal-md">
        <div class="modal-content">   
            ...
            <div class="modal-body text-center">
                <form action="{{URL('/individual-recived-request/'.$user_id)}}" method="post"> 
                {{ csrf_field() }}
         ...
         $(document).on('click','#addbaloptionreq',function(){
             ...
             if(option == 1){
                 ...
                 $.ajax({
                    url: "{{route('backurl')}}",
                    dataType: "json",
                    data: { backUrl:"{{URL('/individual-recived-request/'.$user_id)}}"},
                    success: function(data) {
                        console.log(data);
                        if(data == true){
                             window.location.href="{{URL('/individual-request-payment/'.$user_id)}}";
                        }
                    }
                });
