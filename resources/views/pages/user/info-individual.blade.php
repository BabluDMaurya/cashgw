    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 ">
                ...
                @endif
                <form id="kyc-form" class="individual" name="kycfirst" action="/individualkyc" method="post">                    
                    <div id="wizard" class="individual wizard clearfix" role="application">
                        {{ csrf_field() }}
                ...
                <section>                    
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group bus_cer_main">
                                 <label>Date of Birth <span class="asterik">*</span></label>
                                 <div class="input-group date" id="pos_date_pick" data-provide="datepicker">
                                     <input type="text" id="dobdatepicker" class="form-control" name="dob"  value="{{old('dob')}}" placeholder="DD/MM/YYYY">
                            ...
                            <div class="col-md-6 form-group required bus_cer_main">
                               <label>Passport Expiry Date<span class="asterik">*</span></label>
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" class="form-control" id="passexpdtdatepicker"  name="passexpdt"  value="{{old('passexpdt')}}" placeholder="DD/MM/YYYY">
                                       <div class="input-group-addon">
                                           <span class="glyphicon glyphicon-th"></span>
                                       </div>
                                   </div>
                ...
                <section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                 <label>Zipcode <span class="asterik">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                 <label>Country <span class="asterik">*</span></label>
                ...
                <section> 
                    ...
                    <div class="alert alert-success alert-dismissible"  style="opacity: 0;display: none;">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<script>
    $.fn.datepicker.defaults.format = "dd/mm/yyyy";
     $('.datepicker').datepicker({
            ...
            $('.datepicker').addClass('dobdatepicker');
        });
    
//    $(document).on('click','#dobdatepicker',function(){
//        $('.datepicker-dropdown').addClass('dobdatepicker');
//    });
//    $(document).on('click','#passexpdtdatepicker',function(){
//        $('.datepicker-dropdown').addClass('passexpdtdatepicker');
//    });
</script>
<script>
                $(function ()
