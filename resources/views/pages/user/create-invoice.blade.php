                                    ...
                                    <form action="{{URL('/InsertInvoiceData/')}}" class="common-form" id="InvoiceForm" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="title-equal-space">
                                                ...
                                                @if(session('status'))                                                
                                                <div class="alert alert-success alert-dismissible" style="margin-left: 33px;"> 
                                                ...
                                                <div class=" d-flex w-100">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div id="optionEmail" style="display:none">
                                                            <ul>
                                                                <li class="addItemIcon"><i class="fas fa-plus-circle"></i> Add new customer</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-8">
...
$(document).ready(function() {
        $("#file-preview-show").on('change', function() {
          ...
          var image_holder = $("#create-attach-file");
          image_holder.empty();
