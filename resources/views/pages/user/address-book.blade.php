                                                        ...
                                                        <div class="accordion-group">
                                                            ...
                                                            <div id="collapse{{$addressbookDetails[0]->id}}" class="accordion-body collapse">
                                                                <div class="accordion-inner">
                                                                    <form class="common-form" id="AddressBookEdit" action="{{ url('address-book/'.encrypt($addressbookDetails[0]->user_id)) }}" method="POST">
                                                                        {{ csrf_field() }}
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.getSingleContactDetails', function (e) {
                ...
                $.ajax({
                    url: '{{url("GetSingleContactDetails")}}',
                    type: 'post',
                    data: {id: id},
