...
<section class="main-content">
    <div class="container">
            ...
            <div class="row" id="message">      
                <form action="{{URL('/business-balance/'.$user_id)}}" class="common-form w-100 mb-0 myform" id="ccformpre">
...
<!--                        <div class="form-group col-lg-4">
                    ...
                    <div class="text-center mt-4">                  
                        <form action="{{URL('/business-balance/'.$user_id)}}" class="align-self-center common-form d-flex mb-0 myform" id="newform">
...
<!--                            <input type="hidden" name="cashgw_charge" value="">-->
                            ...
                            <a  href="{{URL('/business-balance/'.$user_id)}}" class="btn dark-btn round-btn btn-inline-block">Cancel</a>                                
                        </form>
                    </div>  
            </div>                
        </div>
