...
<section class="main-content">
        <div class="container">
            <div class="row">   
                <div class="col-md-12">
                    <button type="button" onclick="goBack()" class="btn blue-btn round-btn hvr-sweep-to-top mb-20 float-right back_pos_icon"><i class="fa fa-angle-left"></i> Back</button>
                </div>
                <div class="col-md-12">    
                    <div class="block-item invoice-info shadow-block">    
                        ...
                        <div class="table-responsive payment-table mt-4">
                            <table class="table text-right invoice-details-table">
                                <thead>
                                    <tr>
