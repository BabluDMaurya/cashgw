                    ...
                    <div class="col-md-4 margin-auto">
                        <form class="common-form myform request_payment_amount" method="{{$data['method']}}" action="{{URL($data['url'])}}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="typeuser" type="hidden" value="busi">
                            ...
                            <ul class="account-list currency-list {{ $errors->has('amount') || $errors->has('user_id') || $errors->has('search_text') ? ' is-invalid input-show' : '' }}">
                                ...
                                <li>
                                    <div class="form-group required W-100">
                                        <textarea name="note" class="form-control bg-white {{ $errors->has('note') ? ' is-invalid input-show' : '' }}" value="{{old('note')}}" placeholder="Enter note"></textarea>    
                                    <!--<input type="text" name="note" class="form-control bg-white {{ $errors->has('note') ? ' is-invalid input-show' : '' }}" value="{{old('note')}}" placeholder="Enter note">-->
                                    @if($errors->has('note'))                                                
                                        <span class="invalid-feedback" role="alert" style="display: block">
