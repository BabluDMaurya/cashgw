            ...
            <div class="col-md-12">
                <div class="text-center">
                    ...
                    <div class="col-md-4 margin-auto">
                        <form class="common-form myform" method="GET" action="{{URL('/business-send-money/'.$user_id.'/edit')}}">
                            {{ csrf_field() }}
...
<script>
    ...
    $(document).ready(function () {
        $(".alert-success").fadeTo(9000, 900).slideUp(900, function(){
        $(".alert-success").slideUp(900);
    });
    ...
    $('.myform').each(function(){
        ...
        messages: {
            search_text: {
                ...
                email:"Enter valide Email (example@gmail.com)",
            },
            amount: {
