        ...
        <div class="row">
            <div class="col-md-4">
                <div class="block-item shadow-block">
                    @include('includes.businessdashboardsidebarmenu')
                </div>
            </div>
            <div class="col-md-8">
                <div class="block-item shadow-block">
                    ...
                    <div class="detail-det">
                        <div class="send-request-items">
                            <a href="{{URL('/business-request-payment/'.$user_id)}}" class="send-item" >
                                <div class="ico-img">
                                    <img src="{{URL('public/images/send1.png')}}">
                                </div>
                                <h4>Request from customers</h4>
                                <p>You'll pay a fee when you<br>
                                    receive the payment.
                                </p>
                            ...
                            <a href="{{URL('/business-send-money/'.$user_id)}}" class="send-item" >
                                <div class="ico-img">
