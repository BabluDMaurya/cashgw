                                ...
                                <div class="block-item shadow-block">
                                    <div class="row">
                                        <div class="title-equal-space">
                                            ...
                                            @endif
                                            <div class="">
                                                <a href="#!" class="btn  round-btn  hvr-sweep-to-top  blue-btn" data-toggle="modal" data-target="#add-item">Add a New Item</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="common-form myform" id="itemsManage" action="{{url('/business-manage-item')}}" method="post">
                    {{ csrf_field() }}        
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control notclear {{ $errors->has('currency') ? ' is-invalid' : '' }}" name="currency">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group required tax-visible" style="display: none">
                            ...
                            <select class="notclear tax_name form-control {{ $errors->has('tax_name') ? ' is-invalid' : '' }}" name="tax_name" id="tax_name"> 
                        ...
                        <div class="col-md-3 form-group required tax-visible" style="display: none">
                            <label>Rate</label>
                            <input type="text" class="rateValue form-control {{ $errors->has('rate') ? ' is-invalid' : '' }}" name="rate" value="">
                    ...
                    <div class="col-lg-10 margin-auto">
                        <input type="submit" class="notclear btn btn-dark btn-block round-btn mt-20 mb-20" value="Save">
...
<div class="modal fade " id="edit-item">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form class="common-form myform" id="editManage" action="{{URL('/business-manage-item/'.$user_id)}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group required">
                            <label>Item name</label>
                            <input type="text" class="notclear form-control {{ $errors->has('item_name') ? ' is-invalid' : '' }}" name="item_name" id="item_name">
                            @if($errors->has('item_name'))                                                
                            <span class="invalid-feedback" role="alert" style="display: block">
                                <strong>{{ $errors->first('item_name') }}</strong>
                            </span> 
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group required">
                            <label>Description</label>
                            <textarea class="notclear form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="description"></textarea>
                            @if($errors->has('description'))                                                
                            <span class="invalid-feedback" role="alert" style="display: block">
                                <strong>{{ $errors->first('description') }}</strong>
                            </span> 
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group required">
                            <label>Price</label>
                            <input type="text" class="notclear form-control {{ $errors->has('price') ? ' is-invalid' : '' }}" name="price"  id="price">
                            @if($errors->has('price'))                                                
                            <span class="invalid-feedback" role="alert" style="display: block">
                                <strong>{{ $errors->first('price') }}</strong>
                            </span> 
                    ...
                    <div class="row"> 
                        <div class="col-md-6 form-group required tax-visible">
                            <label>Tax Name</label>
                            <select class="notclear form-control tax_name_edit {{ $errors->has('tax_name') ? ' is-invalid' : '' }}" name="tax_name" id="tax_name">                                 
                                @foreach($taxInfoList as $taxlist)                                                                                                                            
                                <option value="{{$taxlist->tax_name}}">{{$taxlist->tax_name}}</option>                                
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 form-group required tax-visible">
                            <label>Rate</label>
                            <input type="text" class="notclear rateValueEdit form-control {{ $errors->has('rate') ? ' is-invalid' : '' }}" name="rate" id="rate" value="">
                            @if($errors->has('tax_rate'))                                                
                            <span class="invalid-feedback" role="alert" style="display: block">
                                <strong>{{ $errors->first('rate') }}</strong>
                            </span> 
