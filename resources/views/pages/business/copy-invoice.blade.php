                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="block-item shadow-block">
                                    <form action="{{URL('/business-insert-invoice-data/')}}" class="common-form" id="InvoiceForm" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="title-equal-space">
                                                <div class="col-md-6">
                                                    <h5 class="block-title">Copy Invoice</h5>
                                                </div>
                                                @if(session('status'))                                                
                                        ...
                                        <input type="hidden" name="invoice_category_id" value="{{$SingleInvoiceDetails->invoice_cat_id}}">
                                                ...
                                                <div class="col-md-6 no-flex">
                                                    <div class="fileinput fileinput-exists" data-provides="fileinput">                                                    
                                                        <div class="fileinput-preview fileinput-exists thumbnail">  
                                                                ...
                                                                @endphp 
                                                            <img src="{{url('/public/images/')}}/@if(isset($SingleInvoiceDetails['business_logo'])){{$img}}@else{{$individualKyc->photo}}@endif" id="business_logo">                                                   
                                                        </div>                                                        
                                                        <div>
                                                            <span class="btn default btn-file">
                                                                ...
                                                                <input type="hidden" name="invoice_business_logo_pre" value="@if(isset($SingleInvoiceDetails['business_logo'] )){{$SingleInvoiceDetails['business_logo']}}@else{{$individualKyc->photo}}@endif">                                                                
                                                            </span>
                                        ...
                                        <section class="bill-to-sec">                                        
                                            <div class="form-group row">
                                                <div class=" d-flex w-100">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" class="form-control {{ $errors->has('bill_to_email') ? ' is-invalid' : '' }}" id="InvoiceBillTo" name="bill_to_email" value="{{$SingleInvoiceDetails->bill_to_email}}" autocomplete="off" placeholder="Enter Email address">
...
$(document).ready(function() {
        $("#file-preview-show").on('change', function() {
          ...
          var image_holder = $("#bus-copy-attach-file");
          image_holder.empty();
