            ...
            <div class="col-md-12">
                    <div class="block-item shadow-block">
                        <div class="balance-new-title mb-30">
                            ...
                            <select class="text-right payment_history_select float-right" name="archieveView" id="archieveView">
...
<script>
    $(document).on('change','#archieveView',function(){
        ...
        $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}});
            $.ajax({
                url :'{{URL("business-payment-history-archieve-view")}}',
                type :'POST',
    ...
    $(document).on('click','.clickarchive',function(){
        ...
        $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}});
            $.ajax({
                url :'{{URL("business-payment-history-archieve")}}',
                type :'POST',
