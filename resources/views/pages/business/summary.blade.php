    ...
    <div class="container">
        <div class="name-det d-flex">
            ...
            <div class="summary_client_details">
                ...
                <ul>
                    <li>{{$businesskyc->fname}} {{$businesskyc->mname}} {{$businesskyc->lname}}</li>
                    <li>@if(!empty($business->primary_email))
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-right mb-3 button_summary">
                    ...
                    <a href="{{URL('/business-payment-history/'.$user_id)}}" class="btn btn-dark round-btn hvr-sweep-to-top mr-2">Payment History</a>
                </div>
                                        ...
                                        <form action="{{URL('/business-account/')}}" class="common-form myform" method="post" id="AddPhoneNumber">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 form-group required">
                                                    <input type="text" class="form-control {{ $errors->has('phonenumber') ? ' is-invalid' : '' }}" placeholder="Add phone number" id="phonenumber" name="phonenumber" value="{{ old('phonenumber') }}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="position-relative">
                                                        <label class="l-checkbox">
                                                            ...
                                                            <input type="checkbox" name="phonenumbervalue" id="phonenumbervalue" value="1">
                                            ...
                                            <div class="col-lg-10 margin-auto">
                                                <input type="submit" name="submitaddnumber" class="btn btn-dark btn-block round-btn mt-20 mb-20" value="Save Number">
                                            </div>             
                                        </form>
                                    </div>
                                </div>
