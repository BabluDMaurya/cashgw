    ...
    <script src="{{url('/public/js/d3.js')}}"></script>
    <script src="{{url('/public/js/rickshaw.min.js')}}"></script>
    ...
    <script src="{{url('/public/js/ResizeSensor.js')}}"></script>
<!--    <script src="js/dashboard.js"></script>-->
    <script src="{{url('/public/js/slim.js')}}"></script>
