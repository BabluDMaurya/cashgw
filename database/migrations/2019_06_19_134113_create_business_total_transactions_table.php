...
class CreateBusinessTotalTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(!Schema::hasTable('business_total_transactions')){
        Schema::create('business_total_transactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('business_total_transactions');
    }
}
