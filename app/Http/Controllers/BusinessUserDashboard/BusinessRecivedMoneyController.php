...
use App\BusinessKyc;
use App\User;
class BusinessRecivedMoneyController extends Controller
{
    use BalanceTrait;
    public function index($id) {
        try{ 
            ...
            if(empty($errormes)){                  
                return view('pages.business.recived-money',['user_id'=>$id,'balance'=>$this->getBalance(),'requestUsers'=>$results1,'requestAdmin'=>$results2,'sendMoney'=>$results3]);  
            }else{
                Auth::logout();   
