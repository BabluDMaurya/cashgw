...
class BusinessAccountSettingController extends Controller
{
    ...
    public function store(Request $request){    
        ...
        if(isset($request->phonenumber)){
            ...
            if($request->phonenumbervalue == 1){
                $user->business->primary_phone = $request->phonenumber;
                $user->business->save();
                
                $user->master->primary_phone = $request->phonenumber;
                $user->master->save();
            }else{
                $user->business->secondary_phone = $request->phonenumber;
                $user->business->save();
        ...
        if(isset($request->emailaddress)){
            ...
            if($request->emailaddressvalue == 1){
                $user->business->primary_email = $request->emailaddress;
                $user->business->save();
                
                $user->master->primary_email = $request->emailaddress;
                $user->master->save();
            }else{
                $user->business->secondary_email = $request->emailaddress;
                $user->business->save();
        ...
        if(isset($request->addlone)){
            ...
            if($request->addressvalue == 1){
                $user->businesskyc->add_line_one = $request->addlone;
                $user->businesskyc->add_line_two = $request->addltwo;
                $user->businesskyc->town_or_city = $request->towncity;
                $user->businesskyc->zip = $request->zip;
                $user->businesskyc->state = $request->state;
                $user->businesskyc->country = $request->country;
                $user->businesskyc->save();
                
                $user->master->add_line_one = $request->addlone;
                $user->master->add_line_two = $request->addltwo;
                $user->master->town_or_city = $request->towncity;
                $user->master->zip = $request->zip;
                $user->master->state = $request->state;
                $user->master->country = $request->country;
                $user->master->save();
                
            }else{
                $user->business->billing_address_line_one = $request->addlone;
                $user->business->billing_address_line_two = $request->addltwo;
                $user->business->billing_address_townOrcity = $request->towncity;
                $user->business->billing_address_zipcode = $request->zip;
                $user->business->billing_address_state = $request->state;
                $user->business->billing_address_country = $request->country;
                $user->business->save();
    ...
    public function show($id){            
        try{            
            ...
            if(empty($errormes)){
                return view('pages.business.account-setting',['user_id'=>$id,'user_email'=>$user->email,'user_join'=>$user->created_at,'business'=>$user->business,'businesskyc'=>$user->businesskyc,'balance'=>$bal]);  
            }else{
...
//                'MiddleName.required'=>'Middle Name Required',
                ...
                'Country.required'=>'Country Required',
                    ...
                    $user->businesskyc->fname = $request->FirstName;
                    $user->businesskyc->mname = $request->MiddleName;
                    $user->businesskyc->lname = $request->LastName;
                    $user->businesskyc->country = $request->Country;                
                    $user->businesskyc->save();

                    $user->business->lang = $request->LangId;
                    $user->business->save();
    ...
    public function destroy($id){
        ...
        try{            
            ...
            $user->business->account_status = 2;
            $user->business->save();
    ...
    public function BusiAddProfilePic(Request $request) {
        $user = Auth::user();
        $validator = Validator::make($request->all(), [
            'myphoto' => 'required',
                ], [
        ...
        $user->businesskyc->photo = $image_name;
        $user->businesskyc->save();
