...
use App\Currencie;
class BusinessBalanceController extends Controller
{
    ...
    public function show($id)
    {
        try{            
            ...
            if(empty($errormes)){               
                return view('pages.business.balance',['user_id'=>$id,'business'=>$user->business,'businesskyc'=>$user->businesskyc,'balance'=>$bal]);  
            }else{
                Auth::logout();   
    ...
    public function edit(Request $request,$id)
    {
        try{            
            ...
            if(empty($errormes)){               
                return view('pages.business.currency-convert',['user_id'=>$id,'balance'=>$this->getCurrencyBalance($currencydata->id),'currency'=>$request->input('currencytype')]);  
            }else{
                Auth::logout();   
                session()->flash('status',$errormes);
                return redirect('/login');
