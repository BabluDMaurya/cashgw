...
class BusinessSentRequestMoneyController extends Controller
{
    use BalanceTrait;
    /**
    ...
    public function show($id)
    {
        try{ 
            ...
            if(empty($errormes)){                  
                return view('pages.business.sent-request-money',['user_id'=>$id,'balance'=>$this->getBalance(),'requestedMoneyFromUser'=>$usersrecord,'requestedMoneyFromAdmin'=>$adminrecord]);  
            }else{
                Auth::logout();   
