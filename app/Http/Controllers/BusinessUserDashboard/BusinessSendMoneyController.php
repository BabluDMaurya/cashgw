...
class BusinessSendMoneyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($request->otp)){                 
          ...
          return redirect('/business-send-money/'.$request->id);
    }
    ...
    public function show($id)
    {
        try{            
            ...
            if(empty($errormes)){                               
                return view('pages.business.send-money',['user_id'=>$id,'addressBookContacts'=>$addressBookContacts]);  
            }else{
                Auth::logout();   
