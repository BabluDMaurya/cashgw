...
class BusinessRecivedRequestMoneyController extends Controller
{
    ...
    {  
        try{ 
            ...
            if(empty($errormes)){                  
                return view('pages.business.recived-request-money',['user_id'=>$id,'balance'=>$this->getBalance(),'requestedMoneyFromUserdoller'=>$usersrecorddoller,'requestedMoneyFromUsereuro'=>$usersrecordeuro]);  
            }else{
                Auth::logout();   
            ...
            if(!empty($request->brrmaction) && ($decrypted == $user->id)){
                ...
                if($validator->fails()){
                 ...
                 $data = [
                        ...
                        'email'=>$user->email,
                        'recivedrequest' => 'Yes',
                        'url'=>'business-recived-request/'.$id,
                        'murl'=>'business-recived-request/'.$id,
                        ];
