    ...
    public function show($id)
    {
        try {
            ...
            if (empty($errormes)) {  
                ...
                return view('pages.user.business-information',['user_id'=>$id,'selected_id_value'=>$selected_id_value,'allCategory'=>$allCategory]);  
            } else {
                Auth::logout();
...
//    public function DeleteBusinessInfo(Request $request){
//        $id = $request->id;
//        $deleteupdated = BusinessInformations::find(decrypt($id));   
