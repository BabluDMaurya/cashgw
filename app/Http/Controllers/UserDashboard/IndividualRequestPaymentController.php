...
class IndividualRequestPaymentController extends Controller
{
    use UserStatusTrait,AddUserOnAddressBook,PaymentHistoryTrait,ActivityTrait,TransactionIdTrait,Notifiable,UnRegisterEmailTrait;
    public $currentpath;
    /**
...
//            'user_id'=>'required',    
            ...
            'note'=>'required',  
            'search_text' => 'required|email|string|emailformate|exists:users,email|emaildomain',     
            ],[
//            'user_id.required' => 'User Required',  
    ...
    public function show($id)
    {
        try{            
            ...
            if(empty($errormes)){
                return view('pages.user.request-payment',['user_id'=>$id,'addressBookContacts'=>$addressBookContacts]);  
            }else{
                Auth::logout();   
...
//                    $emailonaddressbook = $this->AddUserOnMyAddressbook($request->search_text);            
                ...
                $data = [
                            ...
                            'url'=>'/individual-request-payment',
                            ];
