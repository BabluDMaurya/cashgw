    ...
    public function store(Request $request)
    {
        ...
        if (isset($request->firstTd)) {
            $this->validate($request, [
                ...
                'secondTd' => 'required|integer|min:1|not_in:0',
                    ], [
                ...
                'secondTd.min' => 'Tax Rate must be Greater then 0 only.',          
                'secondTd.not_in' => 'Tax Rate must be positive numbers only.',        
            ]);
    ...
    public function show($id)
    {
        try {
            ...
            if (empty($errormes)) {  
                ...
                return view('pages.user.tax-information',['user_id'=>$id,'taxInfoList'=>$taxInfoList]);  
            } else {
                Auth::logout();
